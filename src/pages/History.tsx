...
export default function History() {
  ...
  const timeline = [
    { year: '1852', text: 'Origine de la Fête des Lumières : hommage à la Vierge Marie.' },
    { year: '1900', text: 'Développement de l’éclairage urbain à Lyon.' },
    { year: '1928', text: 'Premier éclairage public festif sur la colline de Fourvière.' },
    { year: '1960', text: 'Les premiers éclairages décoratifs apparaissent dans Lyon.' },
    { year: '1976', text: 'Introduction d’éclairages artistiques dans les rues commerçantes.' },
    { year: '1989', text: 'La fête devient plus artistique avec des installations modernes.' },
    { year: '1999', text: 'Création d’un parcours lumière à travers la Presqu’île.' },
    { year: '2000', text: 'Lyon se positionne comme capitale internationale des lumières.' },
    { year: '2010', text: 'Explosion du nombre d’artistes internationaux participants.' },
    { year: '2015', text: 'L’événement s’adapte après les attentats de Paris.' },
    ...
    { year: '2023', text: 'Édition hybride avec installations physiques et numériques.' },
  ];
  ...
  return (
    ...
    >
      ...
      <section className="relative z-10 py-32 px-6 max-w-3xl mx-auto" data-scroll-section>
        <h1 className="text-4xl font-bold text-cyan-400 mb-16 text-center drop-shadow-[0_0_10px_cyan]">
        ...
        {timeline.map((item, idx) => {
          ...
          return (
            ...
            >
              <div className={`absolute top-2 w-6 h-6 bg-purple-400 rounded-full shadow-[0_0_15px_#a855f7] ${isLeft ? "-right-3" : "-left-3"}`} />
      ...
      <section data-scroll-section className="py-32 px-6 text-center bg-white">
        <h2 className="text-3xl font-bold text-yellow-700">Lyon, Ville Lumière</h2>
